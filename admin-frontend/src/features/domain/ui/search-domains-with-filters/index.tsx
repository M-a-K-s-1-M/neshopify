...
export function SearchDomainsWithFilters() {
    const [searchParams, setSearchParams] = useSearchParams();

    const search: string = searchParams.get('_domains-search') ?? '';
    ...
    return (
        <Box component="div" p={'lg'} className="search-domains-with-filters" bdrs={'md'}>
